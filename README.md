...
예측한 데이터를 기반으로 어떤 데이터가 뇌졸중에 영향을 더 끼치는지 확인할 수 있도록 모델 설계를 진행하여 사전에 뇌졸중을 조금이라도 방지하도록 목표를 선정. <br>
입력 데이터 10개를 가지고 Train Data와 Test Data의 비율을 7:3으로 나눠 데이터 분석 및 시각화를 진행했으며, 딥러닝의 ANN(MLP)모델로 학습. <br>
